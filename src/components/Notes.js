...
<div className="mb-3">
  ...
  <input type="text" className="form-control" id="etag" name = "etag" value = {note.etag} disabled = {note.etitle.length <5 || note.edescription.length < 5} onChange = {handleChange} />
</div>
